...
if [[ $prog_set == 1 ]]; then
  ...
  pikaur -Syy
  pikaur -S xflux sublime-text-dev hunspell-ru pamac-aur-git megasync-nopdfium trello xorg-xkill ttf-symbola ttf-clear-sans --noconfirm
...
if [[ $vm_setting == 1 ]]; then
    ...
    pikaur -S polybar ttf-weather-icons ttf-clear-sans
