...
##############################################
ESSENTIAL='base cmake linux-zen linux-zen-headers linux-firmware neovim dhcpcd netctl openssh dialog wpa_supplicant zsh'
##############################################
DRIVERS='xorg-server xorg-xinit xorg-xrandr xdotool ntfs-3g gvfs os-prober alsa-lib alsa-plugins alsa-tools alsa-utils alsa-firmware'
##############################################
APPS='bspwm sxhkd dmenu grub kitty sudo wget tar networkmanager ppp git curl tree ranger'
##############################################
FONTS='ttf-liberation ttf-dejavu'
##############################################
OPTS='tmux rsync zsh-theme-powerlevel10k pkgfile'
##############################################
AUR='google-chrome networkmanager-dmenu-git picom-pijulius-git'
##############################################
...
git clone https://github.com/CryZFix/dotfiles
