...
y|mkfs.ext4  /dev/sda2 -L root
y|mkswap /dev/sda3 -L swap
y|mkfs.ext4  /dev/sda4 -L home
...
arch-chroot /mnt sh -c "$(curl -fsSL 'https://github.com/CryZFix/aarchin/blob/e461a64e27bdd1189094ef435d1bd7ebad9cb714/arch2.sh')"
